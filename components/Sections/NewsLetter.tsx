...
const NewsLetter = () => {
  return (
    <section className="relative ">
      <div className="border-y border-gray-200  bg-backgroundAlt">
        <div className="relative mx-auto px-6 md:max-w-full md:px-12 lg:max-w-6xl xl:px-0">
          <div className="items-end justify-between md:flex">
            ...
            <div className="pb-8 relative">
              <img
                src="/images/hubit-cta.png "
                className="w-96"
                alt="hubit stat cards components"
                loading="lazy"
              />
              <img
                src="/images/graph-illustration.png "
                className=" absolute -left-32 w-56 top-24"
                alt="hubit graph two"
                loading="lazy"
              />
            </div>
